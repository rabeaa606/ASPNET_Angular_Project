        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreaterUsername = table.Column<string>(type: "text", nullable: true),
                    Content = table.Column<string>(type: "text", nullable: true),
                    PostCreated = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Posts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Posts_AspNetUsers_CreaterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SourcePostId = table.Column<int>(type: "integer", nullable: false),
                    LikedUserId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostsLikes", x => new { x.SourcePostId, x.LikedUserId });
                    table.ForeignKey(
                        name: "FK_PostsLikes_AspNetUsers_LikedUserId",
                        column: x => x.LikedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostsLikes_Posts_SourcePostId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostsLikes_LikedUserId",
                table: "PostsLikes",
                column: "LikedUserId");
        }
